...
namespace Intership.Migrations
{
    ...
    [Migration("20210630115713_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intership.Data.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("ProductRepair", b =>
                {
                    ...
                    b.HasKey("ProductsId", "RepairsId");

                    b.HasIndex("RepairsId");

                    b.ToTable("ProductRepair");
                });
            ...
            modelBuilder.Entity("ProductRepair", b =>
                {
                    b.HasOne("Intership.Data.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Intership.Data.Entities.Repair", null)
                        .WithMany()
