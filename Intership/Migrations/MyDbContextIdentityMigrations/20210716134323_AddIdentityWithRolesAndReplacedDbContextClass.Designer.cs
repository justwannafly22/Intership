...
{
    [DbContext(typeof(MyDbContextIdentity))]
    [Migration("20210716134323_AddIdentityWithRolesAndReplacedDbContextClass")]
    partial class AddIdentityWithRolesAndReplacedDbContextClass
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intership.Data.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "60eb162c-bdc5-4056-b105-c406242ad2f1",
                            ConcurrencyStamp = "565fdb87-2df9-4f3a-955e-627edf773ba4",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "70d1e966-2848-4d04-bf19-38fbc275f56e",
                            ConcurrencyStamp = "110182fb-13de-4952-baf1-d38d08543db7",
                            Name = "Employee",
                            NormalizedName = "EMPLOYEE"
                        },
                        new
                        {
                            Id = "cadd64eb-fdfd-4e8d-bacc-e441159639fd",
                            ConcurrencyStamp = "bae80eb5-6e15-4874-93ae-682d96b5b1c9",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Intership.Data.Entities.Client", b =>
                {
                    b.HasOne("Intership.Data.Entities.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("Intership.Data.Entities.Client", "UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Intership.Data.Entities.User", null)
                        .WithMany()
